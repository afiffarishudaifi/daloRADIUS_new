    ...
    <div id="wrapper">
        <div id="innerwrapper"> <?php
                        ...
                        <ul class="subnav">
                            <li><a href="javascript:document.invoicelist.submit();"><b>&raquo;</b><?php echo t('button', 'ListInvoices') ?></a>
                                <form name="invoicelist" action="bill-invoice-list.php" method="get" class="sidebar">
                                    <input class="form-control-sm" name="username" type="text" id="invoiceUsername" autocomplete='off' tooltipText='<?php echo t('Tooltip', 'Username'); ?> <br/>' value="<?php if (isset($edit_invoiceUsername)) echo $edit_invoiceUsername; ?>" tabindex=3> <?php
                            ...
                            <li><a href="javascript:document.invoicenew.submit();"><b>&raquo;</b><?php echo t('button', 'NewInvoice') ?></a>
                                <form name="invoicenew" action="bill-invoice-new.php" method="get" class="sidebar">
                                    <input class="form-control-sm" name="username" type="text" id="invoiceUsernameNew" autocomplete='off' tooltipText='<?php echo t('Tooltip', 'Username'); ?> <br/>' value="<?php if (isset($edit_invoiceUsername)) echo $edit_invoiceUsername; ?>" tabindex=3>
                                </form>
                            </li>
			...
			<form name=" billinvoiceedit" action="bill-invoice-edit.php" method="get" class="sidebar">
                                    <input class="form-control-sm" name="invoice_id" type="text" id="invoiceIdEdit" <?php if ($autoComplete) echo "autocomplete='off'"; ?> tooltipText='<?php echo t('Tooltip', 'invoiceID'); ?> <br/>' value="<?php if (isset($edit_invoiceid)) echo $edit_invoiceid; ?>" tabindex=3>
                                    </form>
                            </li>
                            <li><a href="bill-invoice-del.php"><b>&raquo;</b><?php echo t('button', 'RemoveInvoice') ?></a>
                            </li>
                        </ul>
                        <br />
                        ...
                        <ul class="subnav">
                            <form name="billinvoicereport" action="bill-invoice-report.php" method="get" class="sidebar">
                                <h109><?php echo t('button', 'BetweenDates'); ?></h109> <br /> <input name="startdate" type="text" id="startdate" tooltipText='<?php echo t('Tooltip', 'Date'); ?> <br/>' value="<?php if (isset($billinvoice_startdate)) echo $billinvoice_startdate;
                                ...
                                <div id="chooserSpan" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div> <input name="enddate" type="text" id="enddate" tooltipText='<?php echo t('Tooltip', 'Date'); ?> <br/>' value="<?php if (isset($billinvoice_enddate)) echo $billinvoice_enddate;
                                ...
                                <div id="chooserSpan" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div> <br /> <?php
                                                                                                                                                                include_once('include/management/populate_selectbox.php');
                                                                                                                                                                populate_invoice_status_id("All Invoice Types", "invoice_status", "form", "", "%");
                                                                                                                                                                ?>
                                <input name="username" type="text" id="usernameEdit" <?php if ($autoComplete) echo "autocomplete='off'"; ?> tooltipText='<?php echo t('Tooltip', 'Username'); ?> <br/>' value="<?php if (isset($billinvoice_username) && $billinvoice_username != '%') echo $billinvoice_username; ?>" tabindex=1>
                                <br />
