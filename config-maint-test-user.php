...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'configmainttestuser.php') ?>
                    <h144>&#x2754;</h144> </a></h2>
                ...
                <div class="tabber">
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'Settings'); ?>">
                        ...
                        <fieldset>
                            ...
                            <input name='radiusport' type='text' id='radiusport' value='<?php echo $radiusport ?>'
                                tabindex=103 />
                            <br />

                            <label for='nasport' class='form'><?php echo t('all', 'NasPorts') ?>
                            </label>
                            <input name='nasport' type='text' id='nasport' value='<?php echo $nasport ?>'
                                tabindex=104 />
                            <br />
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'Advanced'); ?>">
                        ...
                        <fieldset>
                            ...
                            <label for='dictionaryPath'
                                class='form'><?php echo t('all', 'RADIUSDictionaryPath') ?></label>
                            <input name='dictionaryPath' type='text' id='dictionaryPath'
                                value='<?php echo $dictionaryPath ?>' tabindex=111 />
                            <br />
