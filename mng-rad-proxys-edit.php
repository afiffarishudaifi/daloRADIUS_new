...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'mngradproxysedit.php') ?>
                    <h144>&#x2754;</h144></a></h2>
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'ProxyInfo'); ?>">
                        ...
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <input type='hidden' name='proxyname' id='proxyname'
                                    value='<?php if (isset($proxyname)) echo $proxyname; ?>' />

                                <li class='fieldset'>
                                    <label for='proxyname' class='form'><?php echo t('all', 'ProxyName') ?></label>
                                    <input disabled name='proxyname' type='text' id='proxyname'
                                        value='<?php if (isset($proxyname)) echo $proxyname; ?>' tabindex=100 <img
                                        src='images/icons/comment.png' alt='Tip' border='0'
                                ...
                                <li class='fieldset'>
                                    ...
                                    <input name='retry_delay' type='text' id='retry_delay'
                                        value='<?php if (isset($retry_delay)) echo $retry_delay; ?>' tabindex=102 <img
                                        src='images/icons/comment.png' alt='Tip' border='0'
                                ...
                                <li class='fieldset'>
                                    ...
                                    <input name='retry_count' type='text' id='retry_count'
                                        value='<?php if (isset($retry_count)) echo $retry_count; ?>' tabindex=103 <img
                                        src='images/icons/comment.png' alt='Tip' border='0'
                                ...
                                <li class='fieldset'>
                                    ...
                                    <input name='dead_time' type='text' id='dead_time'
                                        value='<?php if (isset($dead_time)) echo $dead_time; ?>' tabindex=104 <img
                                        src='images/icons/comment.png' alt='Tip' border='0'
                                ...
                                <li class='fieldset'>
                                    ...
                                    <input name='default_fallback' type='text' id='default_fallback'
                                        value='<?php if (isset($default_fallback)) echo $default_fallback; ?>'
                                        tabindex=104 <img src='images/icons/comment.png' alt='Tip' border='0'
