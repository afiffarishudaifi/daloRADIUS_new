        ...
        <div id="innerwrapper">
            ...
            <div id="sidebar">
                ...
                <ul class="subnav">
                    ...
                    <li><a href="mng-rad-hunt-list.php" tabindex=1><b>&raquo;</b><?php echo t('button', 'ListHG') ?></a>
                    </li>
                    <li><a href="mng-rad-hunt-new.php" tabindex=2><b>&raquo;</b><?php echo t('button', 'NewHG') ?></a>
                    </li>
