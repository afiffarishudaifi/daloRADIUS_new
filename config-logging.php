...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'configlogging.php') ?>
                    <h144>&#x2754;</h144></a></h2>
                    ...
                    <ul>
                        ...
                        <li class='fieldset'>
                            ...
                            <select class='form' name="config_pageslogging">
                                <option value="<?php echo $configValues['CONFIG_LOG_PAGES'] ?>">
                                    <?php echo $configValues['CONFIG_LOG_PAGES'] ?> </option>
                                <option value=""> </option>
                        ...
                        <li class='fieldset'>
                            <label for='config_querieslogging'
                                class='form'><?php echo t('all', 'QueriesLogging') ?></label>
                            <select class='form' name="config_querieslogging">
                                <option value="<?php echo $configValues['CONFIG_LOG_QUERIES'] ?>">
                                    <?php echo $configValues['CONFIG_LOG_QUERIES'] ?> </option>
                                <option value=""> </option>
                                <option value="no"> no </option>
                                <option value="yes"> yes </option>
                            </select>
                        ...
                        <li class='fieldset'>
                            <label for='config_actionslogging'
                                class='form'><?php echo t('all', 'ActionsLogging') ?></label>
                            <select class='form' name="config_actionslogging">
                                <option value="<?php echo $configValues['CONFIG_LOG_ACTIONS'] ?>">
                                    <?php echo $configValues['CONFIG_LOG_ACTIONS'] ?> </option>
                                <option value=""> </option>
                                <option value="no"> no </option>
                                <option value="yes"> yes </option>
                            </select>
                        ...
                        <li class='fieldset'>
                            <label for='config_debuglogging'
                                class='form'><?php echo t('all', 'LoggingDebugInfo') ?></label>
                            <select class='form' name="config_debuglogging">
                                <option value="<?php echo $configValues['CONFIG_DEBUG_SQL'] ?>">
                                    <?php echo $configValues['CONFIG_DEBUG_SQL'] ?> </option>
                                <option value=""> </option>
                                <option value="no"> no </option>
                                <option value="yes"> yes </option>
                            </select>
                        ...
                        <li class='fieldset'>
                            <label for='config_debugpageslogging'
                                class='form'><?php echo t('all', 'LoggingDebugOnPages') ?></label>
                            <select class='form' name="config_debugpageslogging">
                                <option value="<?php echo $configValues['CONFIG_DEBUG_SQL_ONPAGE'] ?>">
                                    <?php echo $configValues['CONFIG_DEBUG_SQL_ONPAGE'] ?> </option>
                                <option value=""> </option>
                                <option value="no"> no </option>
                                <option value="yes"> yes </option>
                            </select>
                        ...
                        <li class='fieldset'>
                            <label for='config_filenamelogging'
                                class='form'><?php echo t('all', 'FilenameLogging') ?></label>
                            <input value="<?php echo $configValues['CONFIG_LOG_FILE'] ?>"
                                name="config_filenamelogging" />
                        </li>
