        ...
        <div id="innerwrapper">
            ...
            <div id="sidebar">
                ...
                <ul class="subnav">
                    ...
                    <li><a href="mng-rad-nas-list.php" tabindex=1><b>&raquo;</b><?php echo t('button', 'ListNAS') ?></a>
                    </li>
                    <li><a href="mng-rad-nas-new.php" tabindex=2><b>&raquo;</b><?php echo t('button', 'NewNAS') ?></a>
                    </li>
