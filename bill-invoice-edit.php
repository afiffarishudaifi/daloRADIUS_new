                ...
                <div class="tabber">
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'Invoice'); ?>">
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <input class="button" type="button" value="New Payment" onClick="javascript:window.location = 'bill-payments-new.php?payment_invoice_id=<?php echo $invoiceDetails['id'] ?>';" />


                                <input class="button" type="button" value="Show Payments" onClick="javascript:window.location = 'bill-payments-list.php?invoice_id=<?php echo $invoiceDetails['id'] ?>';" />
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'Items'); ?>">
                        <fieldset>
                            ...
                            <input type='button' name='addItem' value='Add Item' onclick="javascript:addTableRow();" class='button'>
                            <br />
