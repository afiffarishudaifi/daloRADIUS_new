...
function addTableRow() {
    ...
    var plansSelect = "<?php populate_plans("
    ", "
    itemXXXXXXX[plan]
    ", "
    form ", "
    ...
    td5.innerHTML = "<input type='button' name='remove' value='Remove' onclick=\"javascript:removeTableRow(\'" +
        trIdName + "\');\" class='button'>";
...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'billinvoiceedit.php') ?>
                <h144>&#x2754;</h144></a></h2>
            ...
            <div class="tabber">
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                ...
                                <input class="money" name='' type='text' disabled id=''
                                    value='<?php echo $invoiceDetails['totalbilled'] ?>' tabindex=101 />
                            </li>

                            <li class='fieldset'>
                                <label for='' class='form'><?php echo t('all', 'TotalPayed') ?></label>
                                <input class="money" name='' type='text' disabled id=''
                                    value='<?php echo $invoiceDetails['totalpayed'] ?>' tabindex=101 />
                            </li>

                            <li class='fieldset'>
                                <label for='' class='form'><?php echo t('all', 'Balance') ?></label>
                                <input class="money" name='' type='text' disabled id=''
                                    value='<?php echo (float) ($invoiceDetails['totalpayed'] - $invoiceDetails['totalbilled']) ?>'
                                    tabindex=101 />
                            </li>
                            ...
                            <li class='fieldset'>
                                ...
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('invoice_status_id')" />
                            ...
                            <li class='fieldset'>
								...
								?>
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('invoice_type_id')" />
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='user_id' type='text' id='user_id'
                                    value='<?php echo $invoiceDetails['user_id'] ?>' tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('user_idTooltip')" />
                            ...
                            <input value='<?php echo $invoiceDetails['date'] ?>' id='invoice_date' name='invoice_date'
                                tabindex=108 />
                            <img src="library/js_date/calendar.gif"
                                onclick="showChooser(this, 'invoice_date', 'chooserSpan', 1950, <?php echo date('Y', time()); ?>, 'Y-m-d H:i:s', true);">
                            <br />


                            <label for='invoice_notes' class='form'><?php echo t('ContactInfo', 'Notes') ?></label>
                            <textarea class='form'
                                name='invoice_notes'><?php echo $invoiceDetails['notes'] ?></textarea>
                            ...
                            <li class='fieldset'>
                                ...
                                <input class='button' type='button' value='Preview Invoice'
                                    onClick="javascript:window.location.href='include/common/notificationsUserInvoice.php?invoice_id=<?php echo $invoice_id ?>&destination=preview'" />
                                <input class='button' type='button' value='Download Invoice'
                                    onClick="javascript:window.location.href='include/common/notificationsUserInvoice.php?invoice_id=<?php echo $invoice_id ?>&destination=download'" />
                                <input class='button' type='button' value='Email Invoice to Customer'
                                    onClick="javascript:window.location.href='include/common/notificationsUserInvoice.php?invoice_id=<?php echo $invoice_id ?>&destination=email'" />
                ...
                <div class="tabbertab" title="<?php echo t('title', 'Items'); ?>">
                    <fieldset>
                        ...
                        <input type='button' name='addItem' value='Add Item' onclick="javascript:addTableRow();"
                            class='button'>
                        <br />
