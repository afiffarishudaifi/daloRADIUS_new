            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li class='fieldset'>
                        ...
                        <input type='hidden' name='username' type='text' id='username' value='<?php echo $username ?>'
                            tabindex=100 />
                    ...
                    <li class='fieldset'>
                        ...
                        <input class='integer' name='priority' type='text' id='priority' value='<?php echo $priority ?>'
                            tabindex=103 />
