...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'mngradusergroupedit') ?>
                ...
                <fieldset>
                    ...
                    <ul>
                        ...
                        <li class='fieldset'>
                            ...
                            <input type='hidden' name='username' type='text' id='username'
                                value='<?php echo $username ?>' tabindex=100 />
                        ...
                        <li class='fieldset'>
                            ...
                            <input type='hidden' name='groupOld' id='groupOld' value='<?php echo $groupOld ?>'
                                tabindex=101 />
                        ...
                        <li class='fieldset'>
                            ...
                            <input class='integer' name='priority' type='text' id='priority'
                                value='<?php echo $priority ?>' tabindex=103 />
