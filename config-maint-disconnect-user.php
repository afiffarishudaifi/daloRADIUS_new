...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'configmaintdisconnectuser.php') ?>
                    <h144>&#x2754;</h144> </a></h2>
            ...
            <form name="maintdisconnectuser" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="tabber">
                    ...
                    <div class="tabbertab" title="<?php echo t('title', 'Settings'); ?>">
                        ...
                        <fieldset>
                            ...
                            <input name='nasaddr' type='hidden' id='nasaddr' value='<?php echo $nasaddr ?>'
                                tabindex=102 />

                            <select onChange="javascript:setStringTextMulti(this.id,'nasaddr','nassecret')" id='naslist'
                                tabindex=103 class='form'>
				...
				autoComEdit.add('usernameEdit','include/management/dynamicAutocomplete.php','_small','getAjaxAutocompleteUsernames');
                        ...
                        ";
                            ...
                            <label for='customattributes'
                                class='form'><?php echo t('all', 'customAttributes') ?></label>
                            ...
                            <input type='submit' name='submit' value='<?php echo t('button', 'DisconnectUser') ?>'
                                class='button' />
