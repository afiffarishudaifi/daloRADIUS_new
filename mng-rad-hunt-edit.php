...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'mngradhuntedit.php') ?>
            ...
            <div class="tabber">
                ...
                <div class="tabbertab" title="<?php echo t('title', 'HGInfo'); ?>">
                    ...
                    <fieldset>
                        ...
                        <input name='nasipaddress' type='text' id='nasipaddress' value='<?php echo $nasipaddress ?>'
                            tabindex=100 />
                        <br />

                        <label for='groupname' class='form'><?php echo t('all', 'HgGroupName') ?></label>
                        <input name='groupname' type='text' id='groupname' value='<?php echo $groupname ?>'
                            tabindex=101 />
                        <br />
