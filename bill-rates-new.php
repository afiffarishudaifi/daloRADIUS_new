...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'billratesnew.php') ?>
                <h144>&#x2754;</h144></a></h2>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                ...
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('rateNameTooltip')" />
                            ...
                            <li class='fieldset'>
                                ...
                                <input class='integer' name='ratetypenum' type='text' id='ratetypenum' value='1'
                                    tabindex=101 />
                            ...
                            <li class='fieldset'>
                                ...
                                <input class='integer' name='ratecost' type='text' id='ratecost' value='1'
                                    tabindex=103 />
                                <img src="images/icons/bullet_arrow_up.png" alt="+"
