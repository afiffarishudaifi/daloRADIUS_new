...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'mngradrealmsedit.php') ?>
                <h144>&#x2754;</h144></a></h2>
                ...
                <div class="tabbertab" title="<?php echo t('title', 'RealmInfo'); ?>">
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <input type='hidden' name='realmname' id='realmname'
                                value='<?php if (isset($realmname)) echo $realmname; ?>' />
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='type' type='text' id='type' value='<?php if (isset($type)) echo $type; ?>'
                                    tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='authhost' type='text' id='authhost'
                                    value='<?php if (isset($authhost)) echo $authhost; ?>' tabindex=102 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='accthost' type='text' id='accthost'
                                    value='<?php if (isset($accthost)) echo $accthost; ?>' tabindex=103 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='secret' type='text' id='secret'
                                    value='<?php if (isset($secret)) echo $secret; ?>' tabindex=104 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='ldflag' type='text' id='ldflag'
                                    value='<?php if (isset($ldflag)) echo $ldflag; ?>' tabindex=105 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='nostrip' type='text' id='nostrip'
                                    value='<?php if (isset($nostrip)) echo $nostrip; ?>' tabindex=106 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='hints' type='text' id='hints'
                                    value='<?php if (isset($hints)) echo $hints; ?>' tabindex=107 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='notrealm' type='text' id='notrealm'
                                    value='<?php if (isset($notrealm)) echo $notrealm; ?>' tabindex=108 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('realmNotrealmTooltip')" />
