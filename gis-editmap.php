...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'giseditmap.php'); ?>
                <h144>&#x2754;</h144></a></h2>
            ...
            if (GBrowserIsCompatible()) {
                ...
                GEvent.addListener(map, "click", function(marker, point) {
                    ...
                    if (marker) {
                        ...
                        var add_val = confirm("<?php echo t('messages', 'gisedit4'); ?>" + " Geocode: " +
                            geopoint)
                        if (add_val == true) {
