...
<div class="col-lg-9">
    <div class="card">
        ...
        <h2 id="Intro"><a href="#"
                onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'billplansnew.php') ?>
                <h144>&#x2754;</h144></a></h2>
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                ...
                                <select class='form' name='planRecurringBillingSchedule'
                                    id='planRecurringBillingSchedule' tabindex=101>
                    ...
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='planTimeRefillCost' type='text' id='planTimeRefillCost' value=''
                                    tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('planTimeRefillCostTooltip')" />

                                <div id='planTimeRefillCostTooltip' style='display:none;visibility:visible'
                                    class='ToolTip'>
                                    <img src='images/icons/comment.png' alt='Tip' border='0' />
                ...
                <div class="tabbertab" title="<?php echo t('title', 'BandwidthSettings'); ?>">
                    <fieldset>
                        ...
                        <ul>
                            ...
                            <li class='fieldset'>
                                <label for='planBandwidthUp'
                                    class='form'><?php echo t('all', 'PlanBandwidthUp') ?></label>
                                ...
                                <div id='planBandwidthUpTooltip' style='display:none;visibility:visible'
                                    class='ToolTip'>
                                    <img src='images/icons/comment.png' alt='Tip' border='0' />
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='planBandwidthDown' type='text' id='planBandwidthDown' value=''
                                    tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('planBandwidthDownTooltip')" />

                                <div id='planBandwidthDownTooltip' style='display:none;visibility:visible'
                                    class='ToolTip'>
                                    <img src='images/icons/comment.png' alt='Tip' border='0' />
                            ...
                            <li class='fieldset'>
                                <label for='planTrafficTotal'
                                    class='form'><?php echo t('all', 'PlanTrafficTotal') ?></label>
                                <input name='planTrafficTotal' type='text' id='planTrafficTotal' value=''
                                    tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
                                    onClick="javascript:toggleShowDiv('planTrafficTotalTooltip')" />

                                <div id='planTrafficTotalTooltip' style='display:none;visibility:visible'
                                    class='ToolTip'>
                                    <img src='images/icons/comment.png' alt='Tip' border='0' />
                            ...
                            <li class='fieldset'>
                                <label for='planTrafficDown'
                                    class='form'><?php echo t('all', 'PlanTrafficDown') ?></label>
                                ...
                                <div id='planTrafficDownTooltip' style='display:none;visibility:visible'
                                    class='ToolTip'>
                                    <img src='images/icons/comment.png' alt='Tip' border='0' />
                            ...
                            <li class='fieldset'>
                                ...
                                <input name='planTrafficRefillCost' type='text' id='planTrafficRefillCost' value=''
                                    tabindex=101 />
                                <img src='images/icons/comment.png' alt='Tip' border='0'
