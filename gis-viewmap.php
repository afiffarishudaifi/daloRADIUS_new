...
<div class="col-lg-9">
    <div class="card">
        <div class="card-body">
            ...
            <h2 id="Intro"><a href="#"
                    onclick="javascript:toggleShowDiv('helpPage')"><?php echo t('Intro', 'gisviewmap.php'); ?>
                    <h144>&#x2754;</h144></a></h2>
                ...
                if (GBrowserIsCompatible()) {
                    ...
                    function createTabbedMarker(point, htmls, labels) {
                        ...
                        GEvent.addListener(marker, "click", function() {
                            ...
                            if (htmls.length > 2) {
                                htmls[0] = '<div style="width:' + htmls.length * 88 + 'px">' + htmls[0] +
                                    '</div>';
                            }
                            var tabs = [];
					...
					<br/> <a href=acct-hotspot-accounting.php?hotspot=$row[1]> Hotspot Statistics </a> <br/> '], ['Info',
                            'Statistics'
                        ]);
