                        ...
                        <fieldset>
                            ...
                            <ul>
                                ...
                                <li class='fieldset'>
                                    ...
                                    <div id='usernamePrefixTooltip' style='display:none;visibility:visible'
                                        class='ToolTip'>
                                        <img src='images/icons/comment.png' alt='Tip' border='0' />
                                ...
                                <li class='fieldset'>
                                    <label for='startingIndex'
                                        class='form'><?php echo t('all', 'StartingIndex') ?></label>
                                    ...
                                    <div id='startingIndexTooltip' style='display:none;visibility:visible'
                                        class='ToolTip'>
                                        <img src='images/icons/comment.png' alt='Tip' border='0' />
                                ...
                                <li class='fieldset'>
                                    <label for='passwordType'
                                        class='form'><?php echo t('all', 'PasswordType') ?></label>
                                    <?php
									include_once('include/management/populate_selectbox.php');
                                    ...
                                    <div id='passwordTypeTooltip' style='display:none;visibility:visible'
                                        class='ToolTip'>
                                        <img src='images/icons/comment.png' alt='Tip' border='0' />
                                ...
                                <li class='fieldset'>
                                    ...
                                    <input class="integer" name='number' type='text' id='number' value='1'
                                        tabindex='106' />
                                    <img src="images/icons/bullet_arrow_up.png" alt="+"
                                ...
                                <li class='fieldset'>
                                    <label for='groupPriority'
                                        class='form'><?php echo t('all', 'GroupPriority') ?></label>
                                    <input class="integer" name='group_priority' type='text' id='group_priority'
                                        value='0' tabindex='107' />
                                    <img src="images/icons/bullet_arrow_up.png" alt="+"
